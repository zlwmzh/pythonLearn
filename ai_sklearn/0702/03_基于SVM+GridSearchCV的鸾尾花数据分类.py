...
if __name__ == '__main__':
    ...
    """
    svc = SVC(kernel='rbf',C = 1.0, gamma=0.2,probability=True)
    param_grids = {
        'kernel':['linear','rbf','poly'],
        'C':[0.01,0.1,1.0,5.0],
        'gamma':[0.001,0.01,0.1,0.2,0.5,1.0,5.0]
    }


    algo = GridSearchCV(estimator=svc,param_grid=param_grids,cv=3)
    # 模型训练
    ...
    print('最优的模型参数：{}'.format(algo.best_params_))
    # # 8. 看一下属性、API的信息
    # x_test = [
    #     [6.9, 3.1, 5.1, 2.3],
    #     [6.1, 2.8, 4.0, 1.3],
